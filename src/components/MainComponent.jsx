...
import { postComment, fetchCampsites, fetchComments, fetchPromotions, fetchPartner, postFeedback } from '../redux/ActionCreators';
...
class Main extends Component {
    ...
    render() {
        ...
        console.log("main component : " + this.props.partners);
        return (
            <div>
                <Header />
                <TransitionGroup>
